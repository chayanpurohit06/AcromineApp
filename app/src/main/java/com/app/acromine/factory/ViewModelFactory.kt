...
class ViewModelFactory constructor(private val abbreviationRepository: AbbreviationRepository): ViewModelProvider.Factory {

    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return if (modelClass.isAssignableFrom(AbbreviationListViewModel::class.java)) {
            AbbreviationListViewModel(this.abbreviationRepository) as T
        } else {
